...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Book_Titl" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AllowSorting="True" >
            <AlternatingRowStyle BackColor="White" />
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Book_StoreConnectionString %>" DeleteCommand="DELETE FROM [Books] WHERE [Book_Titl] = @Book_Titl" InsertCommand="INSERT INTO [Books] ([Book_Titl], [Book_Description], [Genre], [Book_Author], [Pub_Name], [Book_Price]) VALUES (@Book_Titl, @Book_Description, @Genre, @Book_Author, @Pub_Name, @Book_Price)" SelectCommand="SELECT [Book_Titl], [Book_Description], [Genre], [Book_Author], [Pub_Name], [Book_Price] FROM [Books]" UpdateCommand="UPDATE [Books] SET [Book_Description] = @Book_Description, [Genre] = @Genre, [Book_Author] = @Book_Author, [Pub_Name] = @Pub_Name, [Book_Price] = @Book_Price WHERE [Book_Titl] = @Book_Titl">
            <DeleteParameters>
